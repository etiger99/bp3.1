...
#define ENC28J60_RST 	PGout(8)	//ENC28J60复位引脚
#define ENC28J60_CS  	PGout(7)	//ENC28J60片选引脚
#define ENC28J60_INT	PGin(6)		//ENC28J60中断引脚
...
#define RXSTOP_INIT  	(0x1FFF-3072-1)		//接收buffer终止位置
#define TXSTART_INIT  	(0x1FFF-3072)		//发送buffer的起始位置
